...
Inject the `Database` contract in addition to the table only when a query does not fit the table gateway or query builder. Add it explicitly to that repository's constructor:
