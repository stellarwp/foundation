...
The generated `src/Database/Tables/Reports_Table.php` owns its unprefixed table name and desired schema. `Database::tableName()` applies the current WordPress table prefix.
...
final readonly class Reports_Table extends Table {
	...
	public function __construct(
		...
		parent::__construct( self::TABLE, $database );
	}
