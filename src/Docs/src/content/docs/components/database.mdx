...
<CardGrid>
  <LinkCard title="Migrations" description="Generate migrations, preview SQL, and manage application schema changes." href="/components/migrations/" />
  <LinkCard title="Queries and transactions" description="Use fluent application queries and shared transactions." href="/components/database/query-builder/" />
