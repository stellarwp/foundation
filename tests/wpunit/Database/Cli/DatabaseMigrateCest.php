...
{
	public function _before(WPUnitTester $I): void {
		$this->dropTables($I);
	}

	public function _after(WPUnitTester $I): void {
		$this->dropTables($I);
	}

	public function test_it_runs_database_migrations_through_wp_cli(WPUnitTester $I): void {
	...
	public function test_it_refreshes_and_drops_database_tables_through_wp_cli(WPUnitTester $I): void {
		$I->cli(['foundation', 'migrate', '--run']);
		$I->seeResultCodeIs(0);
		$I->seeInShellOutput('Ran 1 migrations.');
	...
	public function test_it_warns_when_showing_status_before_tables_exist(WPUnitTester $I): void {
		$I->cli(['foundation', 'migrate']);
		$I->seeResultCodeIs(0);
		Assert::assertStringContainsString('The Foundation database tables do not exist.', $I->grabLastShellErrorOutput());
	}

	private function dropTables(WPUnitTester $I): void {
		$I->cli(['db', 'prefix']);
		$I->seeResultCodeIs(0);
